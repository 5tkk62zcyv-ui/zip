...
export function TaxiMark({ className }: { className?: string }) {
  return (
    <span className={cn('relative inline-flex overflow-hidden rounded-full bg-white', className)}>
...
export function BrandLogo({
  ...
  return (
    <span className={cn('inline-flex items-center gap-2', className)}>
      ...
      <span className={cn('font-semibold tracking-tight', textSize)}>택시타쉐어</span>
    </span>
  )
}
